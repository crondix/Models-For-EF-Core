...
namespace FromBDtoJSON.Models
{
    ...
    public class Printers
    {
        ...
        public virtual ICollection<Device_functionsPrinters> Device_functionsPrinters { get; set; }

        public virtual ICollection<Cartridge_modelsPrinters> Cartridge_modelsPrinters { get; set; }

        public virtual ICollection<Printer_InterfacesPrinters> Printer_InterfacesPrinters { get; set; }
